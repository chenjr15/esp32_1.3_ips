...
//    strings with the config you want - ie #define EXAMPLE_WIFI_SSID
//    "mywifissid"
// */
...
// WIFI
// 接受来自系统的WIFI事件，控制重试次数，然后设置s_wifi_event_group的对应标志(连接成功或者失败)
